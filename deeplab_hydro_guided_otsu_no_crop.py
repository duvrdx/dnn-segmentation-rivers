...
for train_num in range(2):
    for train_name, config in trains.items():
        for backbone in backbones:
            print(f"\n{'=' * 80}\nExperimento: {train_name} | Backbone: {backbone} [DeepLabV3 Hydro-Guided No-Crop]\n{'=' * 80}")
            ...
            results_dir = f"./experiments/stats_dl/{train_num}/results_{train_name}_{backbone}_deeplabv3_hydro_guided_no_crop"
...
summary_filepath = "final_results_summary_hydro_guided_no_crop2.txt"
print(f"\nSalvando resumo final em: {summary_filepath}")

with open(summary_filepath, "w", encoding="utf-8") as f:
    f.write("--- RESUMO FINAL DOS EXPERIMENTOS (DEEPLABV3 HYDRO-GUIDED NO-CROP) ---\n")
